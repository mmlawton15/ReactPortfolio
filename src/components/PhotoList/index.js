...
const PhotoList = ({category}) => {
    ...
    const [photos] = useState([
        ...
        },
        {
            ...
            category:"backend",
            path:"employeetrackermakeshift.png",
        ...
        <div>
            ...
            <div className="flex-row">
                {currentPhotos.map((image, i) => (
                    <img
                    src={require(`../../assets/smallImages/${photos.path}`).default}
                    alt={image.name}
